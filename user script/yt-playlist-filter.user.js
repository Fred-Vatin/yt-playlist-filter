...
(() => {
  ...
  * ℹ		SETTINGS
  ...
  const selector_HeaderType2 = "ytd-menu-title-renderer";
  ...
  const selectors_MenuSubElements = [selector_HeaderType1, selector_HeaderType2, selector_ListType1, selector_ListType2];
 ...
 */
  ...
  function filterPlaylist(playlists, filterText) {
    ...
    listItems.forEach((item) => {
      ...
      const formattedString = isType2 ? item.querySelector(selector_ItemType2) : item.querySelector(selector_ItemType1);
